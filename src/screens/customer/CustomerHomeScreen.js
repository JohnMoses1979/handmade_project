...
//   const { cartCount, toggleWishlist, isInWishlist, customerVisibleProducts = [] } = useShop();
...
//     navigation.navigate("CustomerAIChatScreen");
//   }, [navigation]);

//   const liveProducts = useMemo(
//     () =>
//       customerVisibleProducts.slice(0, 6).map((item) => ({
//         ...item,
//         image:
//           item.image ||
...
//     () => customerCategoryCatalog.slice(0, 8),
//     [customerCategoryCatalog]
//   );
...
//             <Text style={styles.subText}>Discover Handmade Products</Text>
//           </View>
...
//         {/* CATEGORY */}
//         <SectionTitle title="Shop by Category" onPress={goToAllCategories} />
...
//         {/* PRODUCTS */}
//         <SectionTitle title="Popular Products" onPress={goToAllProducts} />
...
export default function CustomerHomeScreen({ navigation }) {
  ...
  const onBannerScrollEnd = useCallback((event) => {
